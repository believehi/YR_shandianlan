	...
	<view class="content">
		...
		<view class="uni-rw-time">
			<view class="uni-rw-ms col">
				...
				<view class="uni-rw-yq">
					<text>{{rwArray.CreateDate}}---{{rwArray.EndDate}}</text>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			...
			lqrwlist(e) {
				...
				uni.request({
					url: helper.websiteUrl + 'mtask/gettask',
					method: "GET",
					...
					success: (res) => {
						if (res.data.code == 200) {
							...
							this.rwArray.CreateDate = this.rwArray.CreateDate.substr(0, 10);
							this.rwArray.EndDate = this.rwArray.EndDate.substr(0, 10);
