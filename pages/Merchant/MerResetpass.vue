	...
	export default {
		...
		methods:{
			...
			formSubmit: function(e) {
				...
				uni.request({
					url:helper.websiteUrl+'merchantcenter/checkphone' ,
					method: 'GET',
...
<style>
	...
	.uni-password-but button{margin-top: 75upx;border-radius: 40upx;background-color: #FFFFFF;font-size: 32upx;color: #2FB6A7;letter-spacing: 2upx;}
    .uni-yzm-but{display: flex;}
	.uni-yzm-but view{width: 260upx;height: 80upx;font-size: 30upx;color: #FFFFFF;background-color: #2FB6A7;border-radius: 40upx;line-height: 80upx;text-align: center;margin-left: 15upx;}
